from ControllerIntrinsicCalibration import *

class ViewIntrinsicCalibration():
    def __init__(self, window):
        super(ViewIntrinsicCalibration).__init__()
        self.window = window
        self.controllerIntrinsicCalibration = ControllerIntrinsicCalibration(self.window)
